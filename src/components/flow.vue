...
<div class="ibox">
    <div class="ibox-title">
        <h5><input type='text' placeholder='please input flow name.' v-bind:value='flowName' v-on:input='$emit("editFlowName", $event.target.value)' style='border-style: none;display: inline-block; height: 34px; padding: 6px 0px; font-size: 24px;'></h5>
    ...
    <div class="ibox-content">
        <div class="row">
            ...
            <div class="col-lg-11">
                <div class="ibox float-e-margins border-ibox">
                    <div class="ibox-title">
                        <h5>OrderList</h5>
                        <div class="ibox-tools">
                                <a class="collapse-link" >
...
export default {
	...
	methods: {
        ...
        selectPluginUpdate: function() {
            $(".select2_demo_3").select2({
                placeholder: "Select a state",
                allowClear: true
            });
            var self = this;
            $(".myselect.select2_demo_3").each(function(){
                $(this).val($(this).prev().val());
            });
            $(".myselect.select2_demo_3").change(function(){
                var prev = $(this).prev();
                prev.val($(this).val());
                prev.trigger("click");
            });
